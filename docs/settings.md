...
the code completion. If you need to pass additional flags to the target 
compiler, you can do so by providing a list of flags.
If your completions require the knowledge about the
...
!!! example "Default value"
    ...
    "target_compilers": {
        "C":              "clang",
        "CPP":            {"compiler": "clang", "flags": ["-flag1", "-flag2"]},
        "OBJECTIVE_C":    null,
        "OBJECTIVE_CPP":  null
    },
    ```
