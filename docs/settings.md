...
Can be used to configure additional compiler arguments that get used when retrieving
the default include paths and definitions from the target compiler.
