"""Test cpp_properties flags generation."""
import imp
from os import path, environ
from unittest import TestCase

from EasyClangComplete.plugin.flags_sources import cpp_properties
from EasyClangComplete.plugin import tools
from EasyClangComplete.plugin.utils import flag

imp.reload(cpp_properties)
imp.reload(tools)
imp.reload(flag)

CppProperties = cpp_properties.CppProperties
